...
export const ms: Dictionary = {
  ...
  homePage: {
    ...
    changeTravelTime: "Tukar waktu perjalanan",
  },
  operatingHoursPage: {
    title: "Status laluan",
  ...
  toast: {
    ...
    homeSet: "Dijadikan Utama",
    homeRemoved: "Dibuang sebagai Utama",
    workSet: "Dijadikan Kerja",
    workRemoved: "Dibuang sebagai Kerja",
    skipTodaySet: "Melangkau hari ini",
    skipTodayCleared: "Tidak lagi melangkau hari ini",
    lineFollowed: (lineName: string) => `Mengikuti ${lineName}`,
    lineUnfollowed: (lineName: string) => `Berhenti mengikuti ${lineName}`,
  },
  settings: {
    title: "Tetapan",
    language: "Bahasa",
