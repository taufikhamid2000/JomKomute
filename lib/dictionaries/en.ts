export const en = {
  ...
  toast: {
    ...
    homeSet: "Set as Home",
    homeRemoved: "Removed as Home",
    workSet: "Set as Work",
    workRemoved: "Removed as Work",
    skipTodaySet: "Skipping today",
    skipTodayCleared: "No longer skipping today",
    lineFollowed: (lineName: string) => `Following ${lineName}`,
    lineUnfollowed: (lineName: string) => `Unfollowed ${lineName}`,
  },
  settings: {
    title: "Settings",
    language: "Language",
