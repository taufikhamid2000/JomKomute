...
// Same show/hide toggle pattern as every other app in the portfolio (see
// duitduit/components/password-input.tsx) — one eye-icon button absolutely
// positioned inside the input's right padding.
