...
// Rendered by the server app/report/page.tsx (which owns this route's
// metadata — see that file). Wraps the actual page in Suspense —
// useSearchParams() (below, for the ?legs= route context the home
// screen's "View all reports" link passes) requires it, same as
// app/route/page.tsx's ?id= reader.
